...
export const STORY_FEED_ITEMS: StoryFeedItem[] = [
  {
    ...
    summary: '해운대 해수욕장, 광안리, 태종대 등 8곳을 다녀왔어요. 각 장소 후기를 참고해 주세요!',
    rating: 4.6,
    likesCount: 1,
    images: [
    ...
    places: [
      {
        ...
        rating: 5,
        review: '아침 바다 풍경이 정말 좋았고, 모래사장을 따라 천천히 산책하기에도 딱 좋았어요.',
        tags: ['#바다', '#산책', '#사진스팟'],
        imageUrl:
      ...
      },
      {
        ...
        rating: 4,
        review: '광안대교를 배경으로 보는 야경이 정말 인상적이었고, 밤 분위기도 무척 좋았어요.',
        tags: ['#야경', '#광안대교', '#추천'],
        imageUrl:
      ...
      },
      {
        ...
        rating: 5,
        review: '절벽과 바다가 한눈에 보이는 부산 대표 전망 포인트라서 꼭 한 번 들러볼 만해요.',
        tags: ['#전망', '#바다뷰', '#부산여행'],
        imageUrl:
    ...
    places: [
      {
        ...
        rating: 5,
        review: '골목마다 색감이 살아 있어서 천천히 걷기 좋았고, 사진 찍을 곳도 정말 많았어요.',
        tags: ['#골목산책', '#사진스팟', '#추천'],
        imageUrl:
