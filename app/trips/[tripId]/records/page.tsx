  ...
  return (
    <div className={cn(
      ...
      <div className="p-5">
        ...
        {!hasReview && (
          <p className="mt-2 text-sm text-gray-400">아직 후기가 없어요. 방문 어떠셨나요?</p>
        )}
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <h2 className="text-lg font-bold text-gray-900 mb-1">여행 후기</h2>
          <p className="text-sm text-gray-400 mb-1">
            방문한 여행지마다 후기를 남기고, 원할 때 여행기를 게시할 수 있어요
          </p>
          <p className="text-sm font-semibold text-blue-600 mb-5">
            총 소요시간 {formatDuration(MOCK_TRIP.totalMinutes)}
          </p>
          ...
          <div className="bg-gray-50 rounded-xl p-4 space-y-2">
            <div className="flex items-center justify-between">
              <p className="text-sm font-semibold text-gray-700">
                {completedCount} / {totalCount}곳 후기 완료
              </p>
